...
int main() {
  ...
  RadixSort<int>* intRS = new RadixSort<int>( GetNonNegativeInt ) ;
  RadixSort<Data>* dataRS = new RadixSort<Data>( GetNonNegativeInt ) ;

  intRS->Sort( intPtr, size ) ;
  dataRS->Sort( dataPtr, size ) ;
