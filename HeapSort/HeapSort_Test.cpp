...
int main() {
  ...
  HeapSort<int>* intHS = new HeapSort<int>( IntSmallerEqual ) ;
  HeapSort<Data>* dataHS = new HeapSort<Data>( DataSmallerEqual ) ;

  intHS->Sort( intPtr, size ) ;
  dataHS->Sort( dataPtr, size ) ;
