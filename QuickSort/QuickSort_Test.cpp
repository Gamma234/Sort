...
int main() {
  ...
  QuickSort<int>* intQS = new QuickSort<int>( IntSmallerEqual ) ;
  QuickSort<Data>* dataQS = new QuickSort<Data>( DataSmallerEqual ) ;

  intQS->Sort( intPtr, size ) ;
  dataQS->Sort( dataPtr, size ) ;
