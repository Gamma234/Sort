...
int main() {
  ...
  MergeSort<int>* intMS = new MergeSort<int>( IntSmallerEqual ) ;
  MergeSort<Data>* dataMS = new MergeSort<Data>( DataSmallerEqual ) ;

  intMS->Sort( intPtr, size ) ;
  dataMS->Sort( dataPtr, size ) ;
