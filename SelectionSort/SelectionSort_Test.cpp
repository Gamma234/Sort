...
int main() {
  ...
  SelectionSort<int>* intSS = new SelectionSort<int>( BiggerCompare ) ;
  SelectionSort<Data>* dataSS = new SelectionSort<Data>( BiggerCompare ) ;

  intSS->Sort( intPtr, size ) ;
  dataSS->Sort( dataPtr, size ) ;
